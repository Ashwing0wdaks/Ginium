...
const Task = () => {
   ...
   const [posts, setPosts] = useState([]);
    ...
    const updateTask = async (id, updatedData) => {
        try {
            const response = await axios.put(`http://localhost:4000/tasks/${id}`, updatedData);
    ...
    return (
        <div>
            ...
            <div className="row m-5" >
                <div className="col-3 " style={{marginLeft:"300px"}}>
                ...
                <div className="div border border-1">
                        ...
                        <tbody>
                            {currentRecords.map((eachData) => (
                                <tr key={eachData._id}>
                                    ...
                                    <td>
                                        <button className='btn btn-outline-primary' onClick={() => updateTask(eachData._id, { ...eachData, taskName: 'Updated task name' })}>
                                            {' '}
                                            edit
                                        </button>
                                    </td>
                                    ...
                                    <td>
                                        <button className='btn btn-outline-primary' onClick={() => deleteTask(eachData._id)}> delete</button>
                                    </td>
